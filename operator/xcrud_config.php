...
{
    // default connection
    public static $dbname = 'kependudukan'; // Your database name
    ...
    // editor
    public static $editor_url = 'assets/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
